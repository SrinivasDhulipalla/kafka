...
import kafka.server.epoch.{DummyEpochAction, EpochAction}
...
class Log(@volatile var dir: File,
   ...
   */
  def append(records: MemoryRecords, assignOffsets: Boolean = true, epoch: EpochAction = DummyEpochAction): LogAppendInfo = {
