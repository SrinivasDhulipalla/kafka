...
//  val ReplicationQuotaThrottledReplicas: String = ""
...
object KafkaConfig {
  ...
  val ReplicationQuotaThrottledReplicas = "quota.replication.throttled.replicas"
...
//  val ReplicationQuotaThrottledReplicasDoc = "List of replicas to throttle. This propertly would usually be set dynamically."
...
//      .define(ReplicationQuotaThrottledReplicas, STRING, Defaults.ReplicationQuotaThrottledReplicas, LOW, ReplicationQuotaThrottledReplicasDoc)
...
//  val replicationQuotaThrottledReplicas = getInt(KafkaConfig.QuotaWindowSizeSecondsProp)
