...
class FairnessTest {
  ...
  def shouldCalculateReplicaFairnessForRacks(): Unit = {
    ...
    assertEquals(1, Math.ceil(view.replicaFairness.rackFairValue).toInt)
    assertEquals(0, Math.floor(view.replicaFairness.rackFairValue).toInt)
    ...
    assertEquals(1, Math.ceil(view.replicaFairness.rackFairValue).toInt)
    assertEquals(1, Math.floor(view.replicaFairness.rackFairValue).toInt)
    ...
    view = new RackFairView(brokers, Map(p(0) -> List(100, 101), p(1) -> List(102, 103)))
    assertEquals(2, Math.ceil(view.replicaFairness.rackFairValue).toInt)
    assertEquals(2, Math.floor(view.replicaFairness.rackFairValue).toInt)
  ...
  def shouldCalculateReplicaFairnessForBrokers(): Unit = {
    ...
    assertEquals(1, Math.ceil(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(0, Math.floor(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(Seq(bk1), view.replicaFairness.aboveParBrokers)
    ...
    assertEquals(1, Math.ceil(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(1, Math.floor(view.replicaFairness.brokerFairValue).toInt)
    ...
    assertEquals(2, Math.ceil(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(1, Math.floor(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(Seq(bk0), view.replicaFairness.aboveParBrokers())
    assertEquals(Seq(bk1), view.replicaFairness.belowParBrokers())
    ...
    assertEquals(2, Math.ceil(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(2, Math.floor(view.replicaFairness.brokerFairValue).toInt)
    assertEquals(Seq(), view.replicaFairness.aboveParBrokers())
    assertEquals(Seq(), view.replicaFairness.belowParBrokers())
  ...
  def shouldCalculateLeaderFairnessForRacks(): Unit = {
    ...
    var view = new RackFairView(brokers, Map(p(0) -> List(101)))
    assertEquals(1, Math.ceil(view.leaderFairness.rackFairValue).toInt)
    assertEquals(0, Math.floor(view.leaderFairness.rackFairValue).toInt)
    assertEquals(Seq("rack1"), view.replicaFairness.aboveParRacks)
    assertEquals(Seq("rack2"), view.replicaFairness.belowParRacks)
    ...
    assertEquals(1, Math.ceil(view.leaderFairness.rackFairValue).toInt)
    assertEquals(1, Math.floor(view.leaderFairness.rackFairValue).toInt)
    assertEquals(Seq("rack2"), view.replicaFairness.aboveParRacks())
    assertEquals(Seq("rack1"), view.replicaFairness.belowParRacks())
    ...
    assertEquals(2, Math.ceil(view.leaderFairness.rackFairValue).toInt)
    assertEquals(1, Math.floor(view.leaderFairness.rackFairValue).toInt)
    assertEquals(Seq("rack1"), view.replicaFairness.aboveParRacks())
    assertEquals(Seq("rack2"), view.replicaFairness.belowParRacks())
    ...
    assertEquals(2, Math.ceil(view.leaderFairness.rackFairValue).toInt)
    assertEquals(2, Math.floor(view.leaderFairness.rackFairValue).toInt)
    assertEquals(Seq(), view.replicaFairness.aboveParRacks())
    assertEquals(Seq(), view.replicaFairness.belowParRacks())
  ...
  def shouldCalculateLeaderFairnessForBrokers(): Unit = {
    ...
    var view = new BrokerFairView(List(bk0, bk1), Map(p(0) -> List(101)), "rack1")
    assertEquals(1, Math.ceil(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(0, Math.floor(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(Seq(bk1), view.leaderFairness.aboveParBrokers)
    assertEquals(Seq(bk0), view.leaderFairness.belowParBrokers)

    //2 leaders, 2 brokers, both replicas on one broker
    view = new BrokerFairView(List(bk0, bk1), Map(p(0) -> List(100), p(1) -> List(100)), "rack1")
    assertEquals(1, Math.ceil(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(1, Math.floor(view.leaderFairness.brokerFairValue).toInt)
    ...
    assertEquals(2, Math.ceil(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(1, Math.floor(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(Seq(bk0), view.leaderFairness.aboveParBrokers())
    assertEquals(Seq(bk1), view.leaderFairness.belowParBrokers())
    ...
    assertEquals(2, Math.ceil(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(2, Math.floor(view.leaderFairness.brokerFairValue).toInt)
    assertEquals(Seq(), view.leaderFairness.aboveParBrokers())
    assertEquals(Seq(), view.leaderFairness.belowParBrokers())
