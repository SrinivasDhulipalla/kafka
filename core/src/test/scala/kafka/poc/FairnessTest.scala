...
//    assertEquals(1, Math.ceil(view.replicaFairness.rackFairValueUpper).toInt)
//    assertEquals(0, Math.floor(view.replicaFairness.rackFairValueUpper).toInt)
...
//    assertEquals(2, Math.ceil(view.replicaFairness.rackFairValueUpper).toInt)
//    assertEquals(Seq(), view.replicaFairness.aboveParRacks())
//    assertEquals(Seq("rack2"), view.replicaFairness.belowParRacks())
//
...
//    assertEquals(1, view.replicaFairness.brokerFairValueUpper)
...
//    assertEquals(2, view.replicaFairness.brokerFairValueUpper)
//    assertEquals(Seq(), view.replicaFairness.aboveParBrokers())
//    assertEquals(Seq(bk1), view.replicaFairness.belowParBrokers())
//
