...
class TestRollingSASLUpgrade(ProduceConsumeValidateTest):
    """Tests a rolling upgrade from PLAINTEXT to an SSL enabled cluster.
    """

    def __init__(self, test_context):
        super(TestRollingSASLUpgrade, self).__init__(test_context=test_context)
    ...
    def roll_in_interbroker_security_then_disable_plaintext(self):
        self.kafka.interbroker_security_protocol = "SASL_PLAINTEXT"
        ...
        self.kafka.open_port('SASL_PLAINTEXT')
